...
int main(int argc, char** argv)
{
	...
	while (node.ok())
	{
		...
		try
		{
			...
			listener.lookupTransform("/tb3_4", "/tb3_3", ros::Time(0), transformfl);
		...
		try
		{
			...
			listener.lookupTransform("/tb3_3", "/tb3_4", ros::Time(0), transformlf);
		...
		// 根据tb3_3与tb3_4坐标系之间的位置关系，发布tb3_4的速度控制指令
